...
const Login: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-white font-sans">
      <h2 className="text-2xl text-gray-800 mb-2">Let's get</h2>
      <h1 className="text-3xl font-bold text-center">Started!</h1>
      <form className="flex flex-col items-center w-full max-w-xs mt-6">
        ...
        <button
          className="w-full px-4 py-3 mt-4 bg-gray-50 text-gray-800 rounded-full text-base font-medium flex items-center justify-center hover:bg-gray-100 transition-colors"
        >
