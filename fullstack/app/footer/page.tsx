      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center">
          <div className="flex space-x-4 mb-4">
            ...
            <Link href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300">
              <Youtube size={24} />
            ...
            <Link href="https://discord.com" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300">
              <Discord size={24} />
            ...
            <Link href="mailto:contact@example.com" className="hover:text-gray-300">
              <Mail size={24} />
