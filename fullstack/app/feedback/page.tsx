...
const Feedback = () => {
  ...
  return (
    <div>
      <Navbar />
      <NetworkAnimation />
        <div className="min-h-screen bg-[url('/feedback-bg.jpg')] bg-cover bg-center p-8">
        <div className="max-w-2xl mx-auto bg-black/40 backdrop-blur-sm p-8 rounded-lg text-white mt-32">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 rounded-md bg-gray-200 border border-white/30 focus:outline-none focus:border-white/60"
              />
            </div>
            ...
            <div>
              <textarea
                ...
                className="w-full px-4 py-2 rounded-md text-black bg-gray-200 border border-white/30 focus:outline-none focus:border-white/60 h-32"
              />
            </div>
